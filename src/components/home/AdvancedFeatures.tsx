            ...
            {advancedFeatures.map((feature: Feature, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center text-white text-xl font-bold">
                    {feature.icon}
                  </div>
                  <div>
          ...
          <div className="relative">
            <div className="bg-white p-8 rounded-2xl shadow-2xl">
              ...
              <div className="space-y-4">
                {[
                  { name: "Private LLM", color: "from-blue-600 to-indigo-600" },
                  { name: "Face Recognition", color: "from-indigo-500 to-purple-500" },
                  { name: "Geo-Fencing", color: "from-purple-500 to-pink-500" },
                  { name: "Payroll Engine", color: "from-pink-500 to-red-500" },
                ].map((block, i) => (
